 ...
 */
#if defined(_MSC_VER)
#  include <ZadarmaPJSIP/pj/compat/cc_msvc.h>
#elif defined(__GNUC__)
#  include <ZadarmaPJSIP/pj/compat/cc_gcc.h>
#elif defined(__CW32__)
#  include <ZadarmaPJSIP/pj/compat/cc_mwcc.h>
#elif defined(__MWERKS__)
#  include <ZadarmaPJSIP/pj/compat/cc_codew.h>
#elif defined(__GCCE__)
#  include <ZadarmaPJSIP/pj/compat/cc_gcce.h>
#elif defined(__ARMCC__)
#  include <ZadarmaPJSIP/pj/compat/cc_armcc.h>
#else
 ...
 */
     ...
     * Autoconf
     */
#   include <ZadarmaPJSIP/pj/compat/os_auto.h>

#elif defined(PJ_SYMBIAN) && PJ_SYMBIAN!=0
    /*
     * SymbianOS
     */
#  include <ZadarmaPJSIP/pj/compat/os_symbian.h>
...
#   include <ZadarmaPJSIP/pj/compat/os_win32_wince.h>
...
#   include <ZadarmaPJSIP/pj/compat/os_winphone8.h>
...
#   include <ZadarmaPJSIP/pj/compat/os_winuwp.h>
...
#   undef PJ_WIN32
#   define PJ_WIN32 1
#   include <ZadarmaPJSIP/pj/compat/os_win32.h>

#elif defined(PJ_LINUX_KERNEL) && PJ_LINUX_KERNEL!=0
    /*
     * Linux kernel
     */
#  include <ZadarmaPJSIP/pj/compat/os_linux_kernel.h>
...
#   undef PJ_LINUX
#   define PJ_LINUX	    1
#   include <ZadarmaPJSIP/pj/compat/os_linux.h>

#elif defined(PJ_PALMOS) && PJ_PALMOS!=0
    /*
     * Palm
     */
#  include <ZadarmaPJSIP/pj/compat/os_palmos.h>
...
#   undef PJ_SUNOS
#   define PJ_SUNOS	    1
#   include <ZadarmaPJSIP/pj/compat/os_sunos.h>
...
#   include <ZadarmaPJSIP/pj/compat/os_darwinos.h>

#elif defined(PJ_RTEMS) && PJ_RTEMS!=0
    /*
     * RTEMS
     */
#  include <ZadarmaPJSIP/pj/compat/os_rtems.h>
#else
 ...
 */
     ...
     * Autoconf configured
     */
#include <ZadarmaPJSIP/pj/compat/m_auto.h>
