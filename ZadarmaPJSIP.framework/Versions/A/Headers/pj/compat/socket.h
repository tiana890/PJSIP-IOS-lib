...
#  include <ZadarmaPJSIP/winsock2.h>
#endif

#if defined(PJ_HAS_WINSOCK_H) && PJ_HAS_WINSOCK_H != 0
#  include <ZadarmaPJSIP/winsock.h>
#endif

#if defined(PJ_HAS_WS2TCPIP_H) && PJ_HAS_WS2TCPIP_H != 0
#   include <ZadarmaPJSIP/ws2tcpip.h>
#endif
...
#   include <ZadarmaPJSIP/linux/net.h>
#   include <ZadarmaPJSIP/asm/ioctls.h>		/* FIONBIO	*/
#   include <ZadarmaPJSIP/linux/syscalls.h>	/* sys_select() */
#   include <ZadarmaPJSIP/asm/uaccess.h>	/* set/get_fs()	*/
